...
public class common {
    ...
    public final static String getCatList(){
        return "<option>FRONTEND LEADER</option>"
                + "<option>PYTHON DEVELOPER</option>"
                + "<option>INSTRUCTOR IN COMPUTER TECHNOLOGYSQL </option>"
                + "<option>DATABASE ADMINISTRATOR</option>"
                + "<option>IT AUDITOR - RISK AND COMPLIANCE</option>"
                + "<option>EXECUTIVE - IT APPLICATION SUPPORT</option>"
                + "<option>QA – AUTOMATION ENGINEER</option>"
                + "<option>SOFTWARE ENGINEER - JAVA</option>"
                + "<option>ASSISTANT MANAGER - ENTERPRISE CHANNELS AND PARTNER ENGAGEMENT</option>"
